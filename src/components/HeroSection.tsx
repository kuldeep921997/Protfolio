...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-start relative overflow-hidden bg-background pt-4 px-6 sm:px-8 md:px-12 lg:px-16">
      ...
      <div className="relative z-10 w-full max-w-5xl">
        <motion.h1
          ...
          className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black tracking-tight leading-[0.9] mb-6 text-left pt-7"
        >
        ...
        >
          <a href="#projects" className="px-6 py-3 rounded-full bg-primary text-primary-foreground font-medium text-sm hover:opacity-90 transition-opacity">
            View Projects
          </a>
          <a
          ...
          <a href="#contact" className="px-6 py-3 rounded-full border border-border text-foreground font-medium text-sm hover:bg-secondary transition-colors">
            Contact Me
          </a>
        </motion.div>
